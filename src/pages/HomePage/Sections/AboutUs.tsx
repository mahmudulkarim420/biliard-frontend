                                ...
                                <div className="text-[#ff3b30]">
                                    <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_151_24)">
                                            <path d="M1.5625 10.9395C1.5625 13.4259 4.03179 15.8104 8.42719 17.5686C12.8226 19.3267 18.784 20.3145 25 20.3145C31.216 20.3145 37.1775 19.3267 41.5729 17.5686C45.9681 15.8104 48.4375 13.4259 48.4375 10.9395C48.4375 8.45304 45.9681 6.06848 41.5729 4.31033C37.1775 2.55217 31.216 1.56445 25 1.56445C18.784 1.56445 12.8226 2.55217 8.42719 4.31033C4.03179 6.06848 1.5625 8.45304 1.5625 10.9395Z" stroke="#FF3838" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M1.5625 10.9395V24.9999C1.5625 30.177 12.0562 34.3749 25 34.3749C37.9437 34.3749 48.4375 30.1791 48.4375 24.9999V10.9395" stroke="#FF3838" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
