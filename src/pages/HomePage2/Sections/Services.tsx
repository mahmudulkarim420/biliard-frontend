...
const Services = () => {
  return (
    <section className="relative z-20 w-full bg-[#F3F3F3] section-padding mt-16 md:mt-18 lg:mt-20 xl:mt-22 overflow-hidden">
      ...
      <div className="mx-auto max-w-300 xl:max-w-[1280px] 2xl:max-w-[1280px] px-5 md:px-8 xl:px-0 relative z-10">
