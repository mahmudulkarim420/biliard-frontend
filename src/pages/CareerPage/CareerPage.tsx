          ...
          <div className="px-5 md:px-8 xl:px-0 mx-auto max-w-300 xl:max-w-[1280px] 2xl:max-w-[1440px] ">
            <div>
              <div className="mx-auto max-w-[80%] text-center lg:mx-0 lg:max-w-100 lg:text-left xl:max-w-[600px] 2xl:max-w-[700px]">
                <h2 className="text-[36px] font-semibold leading-[1.1] tracking-tight text-title md:text-[54px] xl:text-[62px] 2xl:text-[72px]">
                ...
                {jobs.map((job, idx) => (
                  ...
                  >
                    <div className="text-center md:text-left lg:max-w-[90%] xl:max-w-[85%]">
                      <h4 className="text-[20px] font-bold text-title xl:text-[24px] 2xl:text-[28px]">
                        {job.title}
                      </h4>
                    </div>

                    <div className="text-center md:text-left">
                      <p className="text-[14px] font-medium text-desc md:text-[18px] xl:text-[20px] 2xl:text-[22px]">
                        {job.salary}
                      </p>
                    </div>
                    ...
                    <div className="flex justify-center md:justify-end lg:justify-self-end">
                      <button className="inline-flex items-center gap-2 border-b border-brand/30 pb-1 text-[16px] font-semibold text-brand transition-all group-hover:border-brand xl:text-[18px] 2xl:text-[20px]">
                        Explore More
