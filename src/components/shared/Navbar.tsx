...
import { Menu, X, ChevronDown, ShoppingCart, Search, MessageSquare, Phone } from "lucide-react";
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center space-x-6">
              <div className="flex items-center space-x-4">
                <button className="text-gray-300 hover:text-white"><ShoppingCart className="h-5 w-5" /></button>
                <button className="text-gray-300 hover:text-white"><Search className="h-5 w-5" /></button>
              </div>
        ...
        <div className="flex flex-col space-y-6">
          {navLinks.map((link) => (
            <Link
              ...
              to={link.href}
              onClick={() => setIsOpen(false)}
              className="group flex items-center justify-between text-lg font-semibold text-gray-300 transition-colors hover:text-[#ff3b30]"
            >
              {link.name}
              <div className="h-1 w-1 rounded-full bg-[#ff3b30] opacity-0 transition-opacity group-hover:opacity-100" />
            </Link>
          ))}
        </div>
          ...
          <div className="flex flex-col space-y-4">
            <div className="flex items-center gap-3">
              <div className="bg-[#ff3b30]/10 p-2 rounded-lg">
                <Phone className="h-5 w-5 text-[#ff3b30]" />
              </div>
              <div className="flex flex-col">
